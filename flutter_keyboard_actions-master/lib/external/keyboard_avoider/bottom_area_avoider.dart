...
class BottomAreaAvoiderState extends State<BottomAreaAvoider> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.child is ScrollView) {
      ...
      /*如果一个ScrollView 没有显示的设置controller并且 会使用primary 是true 会使用PrimaryScrollController.of(context)*/
      _scrollController =
  ...
  /*todo widget.areaToAvoid 会修改？？？*/
  Widget _buildAnimatedContainer(Widget child) {
    print("ccccccccccccccccccccc==areaToAvoid=${widget.areaToAvoid}");
